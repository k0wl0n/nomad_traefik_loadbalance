...
apt update && apt install curl unzip net-tools -y

LOCAL_IP=`curl -s http://169.254.169.254/metadata/v1/interfaces/public/0/ipv4/address`
CONSUL_SERVER_IP=128.199.168.136
